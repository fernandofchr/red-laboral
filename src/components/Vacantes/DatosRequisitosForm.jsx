        ...
        <GridItem>
          ...
          >
            {EXPERIENCIA_LABORAL.map((experiencia, i) => (
              <option value={experiencia} key={i}>
                {experiencia}
              </option>
            ))}
          </Select>
        ...
        <GridItem gridColumn={{ base: "auto", sm: "auto", md: "1 / 3" }}>
          ...
          >
            {Escolaridad.map((escolaridad, i) => (
              <option key={i} value={escolaridad}>
                {escolaridad}
              </option>
            ))}
          </Select>
        ...
        <Box flex="2">
          ...
          >
            {NivelIdiomas.map((nivelIdioma, i) => (
              <option value={nivelIdioma} key={i}>
                {nivelIdioma}
              </option>
            ))}
          </Select>
        </Box>
        <Box alignSelf="end" w={{ base: "100%", sm: "100%", md: "auto" }}>
          <Button
