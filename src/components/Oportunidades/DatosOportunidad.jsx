          ...
          <Stack divider={<StackDivider />} spacing="4">
            <Box>
              ...
              >
                ...
                <Text>
                  <strong>Salario:</strong> ${oportunidad.salarioMin} - $
                  {oportunidad.salarioMaximo} - {oportunidad.periodoPago}
                </Text>
                <Text>
            ...
            <Box>
              ...
              >
                <Text>
                  ...
                  {oportunidad.experienciaLaboral}
                </Text>
                <Text>
                ...
                <Text>
                  <strong>Edad:</strong> {oportunidad.edadMin} años a{" "}
                  {oportunidad.edadMax} años
                </Text>
              </Grid>
            </Box>
            <TagsDatosVacante
