    ...
    <Flex justifyContent="center">
      <Card boxShadow="2xl" h="40rem" overflowY="scroll">
        <CardHeader>
          ...
          <Heading as="h3" size="sm" color="#79f0f7">
            Postulado(a)
          </Heading>
        </CardHeader>
        <CardBody>
          <Stack divider={<StackDivider />} spacing="4">
            <Box>
              ...
              >
                ...
                <Text>
                  <strong>Salario:</strong> ${postulado.salarioMin} - $
                  {postulado.salarioMax} - {postulado.periodoPago}
                </Text>
                <Text>
            ...
            <Box>
              ...
              >
                <Text>
                  ...
                  {postulado.experienciaLaboral}
                </Text>
                <Text>
                  <strong>Género:</strong> {postulado.genero}
                </Text>
                <TagsDatosVacante titulo={"Idiomas"} tags={postulado.idioma} />
                <Text>
                  <strong>Escolaridad:</strong> {postulado.escolaridad}
                </Text>
                <Text>
                  <strong>Edad:</strong> {postulado.edadMin} años a{" "}
                  {postulado.edadMax} años
                </Text>
              </Grid>
            </Box>
            <TagsDatosVacante
